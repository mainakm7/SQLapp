...
def test_read_todos_admin_authenticated(test_todo):
...
def test_delete_todos_admin_authenticated(test_todo):
...
def test_delete_todos_not_found_admin_authenticated(test_todo):
